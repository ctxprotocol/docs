...
- **Named providers still use Auto Mode by default.** If the user says "using Coinglass and Velo" or names venues/tools in a normal question, keep that constraint in the `question` text and do not call `context_discover` first.
