...
2. Capture a Routine Recipe from the terminal result, including the exact question, assumptions, and `toolsUsed` names and IDs.
...
See [Agent Data Routines](/sdk/agent-routines) for a copy-paste routine prompt and SDK example shape.
