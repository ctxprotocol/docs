...
<Tip>
Building a daily report or repeatable analyst job? See [Agent Data Routines](/sdk/agent-routines) and the TypeScript example `examples/client/src/agent-routine.ts`.
</Tip>
