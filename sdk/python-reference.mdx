...
<Info>
**Which should I use?** Use **Query** when you want a curated answer — Context is the librarian and handles answer-safe discovery/orchestration (up to 100 MCP calls per response turn). Use **Execute** when your app/agent is the librarian and you want explicit method pricing with session-budgeted spend control.
</Info>
