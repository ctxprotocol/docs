...
<Info>
Execute eligibility is method-level: methods without explicit `_meta.pricing.executeUsd` remain query-only in Execute discovery.
</Info>

<Tip>
Execute pricing is usually much lower than listing response pricing because it is charged per method call. A common starting point is approximately **1/100 of your listing response price**.
</Tip>
