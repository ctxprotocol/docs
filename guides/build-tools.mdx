...
<Info>
**Earnings Model**: You earn **90%** of usage fees. Set a **query price** (e.g., \$0.01/response) for Query surface usage, and optionally set **method-level execute pricing** for Execute surface calls. Payment is settled automatically after successful execution flows.
</Info>
...
| Price | Use Case |
|-------|----------|
| **Query price: \$0.00** | Free listing usage in Query surface |
| **Query price: \$0.01+** | Paid Query usage (per response) |
