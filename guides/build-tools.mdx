...
The platform reads these fields during orchestration to generate correct arguments for your methods. Without them, the AI must guess valid values from the description alone — leading to more retries and lower first-pass success rates.
