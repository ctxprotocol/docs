...
<Note>
If you are validating a local or preview runtime on your own machine, prefer omitting `agentModelId` or setting `agentModelId: "glm-5.2-model"` unless you are intentionally comparing models. GLM 5.2 is the platform default used by the chat app.
</Note>
