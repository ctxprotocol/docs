...
<Note>
If you are validating a local or preview runtime on your own machine, prefer omitting `agentModelId` or setting `agentModelId: "kimi-k2.6-model"` unless you are intentionally comparing models. Kimi K2.6 is the platform default used by the chat app.
</Note>
