...
<Steps>
  <Step title="Analyze the API">
    Use the **[MCP Server Analysis Prompt](https://github.com/ctxprotocol/sdk/blob/main/docs/mcp-server-analysis-prompt.md)** to:
    - Understand the API's capabilities
    - Generate submission details for the marketplace form
    - Identify the best tools to expose
    
    ```
    Paste the mcp-server-analysis-prompt.md into your AI chat, then provide your API documentation or Context7 library ID.
    ```
  </Step>
...
<AccordionGroup>
  ...
  <Accordion title="Tier 3: Async Jobs (future)" icon="clock">
    ...
    - User submits query → gets job ID
