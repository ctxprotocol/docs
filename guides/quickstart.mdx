...
<Steps>
  ...
  <Step title="Refresh Skills">
    1. Go to [ctxprotocol.com](https://ctxprotocol.com)
    2. Navigate to your **Developer Tools** page (My Tools)
    3. Find your tool and click **"Refresh Skills"**
    4. Context will re-call `listTools()` to discover your new/updated tools
  </Step>
