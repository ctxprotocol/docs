...
- **Signature Requests** — EIP-712 typed data signing (Hyperliquid, Polymarket, dYdX)
...
Best for platforms with proxy wallets (Hyperliquid, Polymarket, dYdX).
...
<AccordionGroup>
  ...
  <Accordion title="Use signatures over transactions" icon="pen">
    ...
    Most DeFi platforms (Hyperliquid, Polymarket, dYdX) use proxy wallets that accept signatures.
  </Accordion>
