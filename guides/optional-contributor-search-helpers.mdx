...
- If a design spike or local validation run exercises a judge, use the platform default `glm-5.2-model` locally unless you are intentionally comparing models.
