...
- If a design spike or local validation run exercises a judge, use the platform default `kimi-k2.6-model` locally unless you are intentionally comparing models.
