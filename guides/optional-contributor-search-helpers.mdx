...
- If a design spike or local validation run exercises a judge, omit `agentModelId` to use the platform default locally unless you are intentionally comparing models.
...
- Still-ambiguous fixture: a low-confidence signal survives instead of fake certainty
