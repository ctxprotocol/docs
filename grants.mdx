...
The ideas above are primarily **Query mode** tools — curated intelligence that replaces expensive subscriptions. But there's an equally valuable category of tools designed for **Execute mode**: normalized data infrastructure that eliminates the pain of integrating fragmented APIs.
...
<Steps>
  ...
  <Step title="Debug & Refine">
    Before requesting review, test your tool thoroughly:
    - Enable **Developer Mode** in Settings > Developer Settings
    - Query your tool and check the Developer Logs for errors
