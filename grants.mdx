...
<Steps>
  ...
  <Step title="Request Review">
    ...
    - Your **tool ID** from ctxprotocol.com (found on your tool's listing page)
...
- **50% on approval**: Seed funding sent when your grant is approved, so you can start building immediately
