...
<Info>
**🎯 North Star:** We fund MCP tools that unbundle curated data sources people currently pay for via subscriptions. If someone is paying \$500/year for it today, your tool can deliver it for \$0.10/response.
</Info>
...
- **Return raw data without curation**: Public APIs are fine as data sources, but we're not paying for JSON wrappers. Add the analysis, labeling, scoring, or synthesis that makes the data actionable. That's what premium subscriptions charge for.
...
- **Lack evidence of an expensive subscription**: "This would be useful" isn't enough. Show us the \$500/year subscription people are actually paying for.

**The bar:** Can you find real Twitter threads, forum posts, or Reddit threads of people complaining or evangelising about paying for this specific data? If not, don't apply.
</Warning>
...
Your proposal should say: *"SensorTower charges \$5K/year. Users on Twitter report paying primarily for download estimates. Here's my tool that delivers that specific data point for \$0.10/query. Here are 3 tweets proving demand."*

<Info>
**This is the bar.** Every idea below has been evaluated against this standard. If you're pitching something not on this list, show us you've done this research.
</Info>
...
We're actively funding tools across these verticals. These ideas target **specific features of expensive subscriptions**, not commodity data. If you have a novel idea with evidence of an expensive paywall, pitch it.
...
<Note>
**What we're NOT funding in crypto:** Honeypot detectors, gas oracles, yield aggregators, bridge routers, funding rate scanners. These are already solved by free tools (DeFiLlama, CoinGecko, exchange APIs) with no premium tier worth unbundling. The \$2.5K/year Nansen subscription exists because of *wallet intelligence*. That's where the value is.
</Note>
...
<Steps>
  ...
  <Step title="Register Your Tool">
    ...
    - **Set your price to \$0** for initial testing (you can change it after we review)
  ...
  <Step title="Get Paid">
    ...
    - Update your price from \$0 to your desired query fee
