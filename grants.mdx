...
Context Protocol is a decentralized marketplace where AI agents pay for data. Build an MCP tool that delivers valuable insights, and you earn **90% of usage fees** (Query responses and eligible Execute calls).
...
<Steps>
  ...
  <Step title="Register Your Tool">
    ...
    - **Set your query price to \$0** for initial testing (you can change it after we review)
  ...
  <Step title="Get Paid">
    ...
    - Update your query price from \$0 to your desired query fee
    - Optionally enable execute pricing for methods you want in Execute surface
