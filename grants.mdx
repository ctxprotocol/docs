...
<Steps>
  ...
  <Step title="Register Your Tool">
    ...
    - **Advanced (optional):** If you also want SDK developers to call your methods directly with per-call billing ([Execute mode](/guides/tool-metadata#pricing-%26-execute-mode-eligibility)), set a default execute price — typically ~1/100 of your response price. Skip this if you're starting with Query mode only; you can enable it later.
