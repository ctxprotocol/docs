...
Build a standard MCP server, paste your endpoint URL, set a query price, optionally add method-level execute pricing, and get paid in USDC when agents use your tool.
