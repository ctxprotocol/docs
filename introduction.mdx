...
| Role | What You Use |
|------|--------------|
| **AI Agent Developer** | `@ctxprotocol/sdk` (TypeScript) or `@ctxprotocol/sdk-python` (Python) — Query marketplace, execute tools, handle payments |
...
| **Instant Revenue** | Set a price (e.g., \$0.01/response). Get paid in USDC instantly every time an Agent calls your tool |
