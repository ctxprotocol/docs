...
<Info>
**Tool contributors wrapping rate-limited APIs:** publish `_meta.rateLimit` hints so Context can pace planner/runtime calls safely. Start with [Rate-Limit Metadata](/guides/rate-limit-metadata).
</Info>
